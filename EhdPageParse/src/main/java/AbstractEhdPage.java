...
public abstract class AbstractEhdPage {
    ...
    protected void selectFirstDocumentFromGridWithIndex() throws NoSuchElementException{
        List<WebElement> docList = driver.findElements(documentsGrid);
    ...
    protected EhdDocumentWindow openDocumentCard(){
