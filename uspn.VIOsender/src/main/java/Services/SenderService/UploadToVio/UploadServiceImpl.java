package Services.SenderService.UploadToVio;

import Services.SenderService.UploadToVio.interfaces.UploadService;
import Services.SenderService.UploadToVio.interfaces.UploadServiceRest;
...
public class UploadServiceImpl implements UploadServiceRest, UploadService {
    ...
    public String upload(File file) throws Exception {
        ...
        logger.info(String.format("Upload service. ID: %s - file: %s"
                , requestMessage, file.getName()));
        logger.trace(String.format("Upload service:" +
                        "\r\n\t%s method to URL: %s" +
                        "\r\n\tUploading file: %s" +
                        "\r\n\tRequest message: %s"
