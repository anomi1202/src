...
set CLASSPATH=%APP_HOME%\lib\selenium-firefox-driver-3.12.0.jar;%APP_HOME%\lib\selenium-remote-driver-3.12.0.jar;%APP_HOME%\lib\com.ibm.mq.jmqi.jar;%APP_HOME%\lib\jsr305-1.3.9.jar;%APP_HOME%\lib\selenium-opera-driver-3.12.0.jar;%APP_HOME%\lib\stax-api-1.0-2.jar;%APP_HOME%\lib\selenium-ie-driver-3.12.0.jar;%APP_HOME%\lib\selenium-java-3.12.0.jar;%APP_HOME%\lib\selenium-api-3.12.0.jar;%APP_HOME%\lib\log4j-1.2.17.jar;%APP_HOME%\lib\okio-1.13.0.jar;%APP_HOME%\lib\selenium-edge-driver-3.12.0.jar;%APP_HOME%\lib\com.ibm.mqjms.jar;%APP_HOME%\lib\commons-exec-1.3.jar;%APP_HOME%\lib\selenium-support-3.12.0.jar;%APP_HOME%\lib\jms.jar;%APP_HOME%\lib\commons-logging-1.2.jar;%APP_HOME%\lib\selenium-safari-driver-3.12.0.jar;%APP_HOME%\lib\dhbcore.jar;%APP_HOME%\lib\jta.jar;%APP_HOME%\lib\slf4j-api-1.7.25.jar;%APP_HOME%\lib\checker-compat-qual-2.0.0.jar;%APP_HOME%\lib\MQSender-1.0.1.jar;%APP_HOME%\lib\slf4j-log4j12-1.7.25.jar;%APP_HOME%\lib\httpcore-4.4.6.jar;%APP_HOME%\lib\error_prone_annotations-2.1.3.jar;%APP_HOME%\lib\j2objc-annotations-1.1.jar;%APP_HOME%\lib\byte-buddy-1.8.3.jar;%APP_HOME%\lib\httpclient-4.5.3.jar;%APP_HOME%\lib\jcommander-1.72.jar;%APP_HOME%\lib\gson-2.8.4.jar;%APP_HOME%\lib\guava-23.6-jre.jar;%APP_HOME%\lib\build-1.0.5.jar;%APP_HOME%\lib\commons-codec-1.10.jar;%APP_HOME%\lib\animal-sniffer-annotations-1.14.jar;%APP_HOME%\lib\okhttp-3.9.1.jar;%APP_HOME%\lib\selenium-chrome-driver-3.12.0.jar
