...
set CLASSPATH=%APP_HOME%\lib\com.ibm.mq.jmqi.jar;%APP_HOME%\lib\dhbcore.jar;%APP_HOME%\lib\jta.jar;%APP_HOME%\lib\slf4j-api-1.7.25.jar;%APP_HOME%\lib\stax-api-1.0-2.jar;%APP_HOME%\lib\MQSender-1.0.1.jar;%APP_HOME%\lib\slf4j-log4j12-1.7.25.jar;%APP_HOME%\lib\log4j-1.2.17.jar;%APP_HOME%\lib\jcommander-1.72.jar;%APP_HOME%\lib\gson-2.8.4.jar;%APP_HOME%\lib\com.ibm.mqjms.jar;%APP_HOME%\lib\MqSender2-1.0-SNAPSHOT.jar;%APP_HOME%\lib\jms.jar
