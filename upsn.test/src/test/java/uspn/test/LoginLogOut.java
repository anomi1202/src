...
public class LoginLogout {
    ...
    public void checkLogin() throws Exception {
        Assert.assertEquals(driver.findElement(By.id("user")).getText(), "Косых Руслан");
        Assert.assertEquals(driverNotification.findElement(By.id("user")).getText(), "Косых Руслан");
    }
    ...
    public void checkGotoDocPages() throws Exception {
        ...
        Assert.assertEquals(text.toString(), "Входящие документы/Реестры/Реестр решение суда");
    }

    @Test
    public void checkGotoNotifPages() throws Exception {
        Assert.assertEquals(driverNotification.findElement(By.id("jqgh_notificationList_startDate")).getText(), "Дата сообщения");
        Assert.assertEquals(driverNotification.findElement(By.id("jqgh_notificationList_title")).getText(), "Тема сообщения");
        Assert.assertEquals(driverNotification.findElement(By.id("jqgh_notificationList_notificationMessageType")).getText(), "Тип сообщения");
        Assert.assertEquals(driverNotification.findElement(By.id("jqgh_notificationList_none")).getText(), "Информация");
    }
    ...
    public void exitPages() {
        ...
        Assert.assertEquals(driver.findElement(By.id("title")).getText(), "Выход из системы выполнен успешно");
        Assert.assertEquals(driverNotification.findElement(By.id("title")).getText(), "Выход из системы выполнен успешно");
    }
